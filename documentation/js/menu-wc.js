                                ...
                                <a href="modules/AppModule.html" data-type="entity-link" >AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-a91ca7c371dc17046fd1789cc6d5dfc8"' : 'data-target="#xs-components-links-module-AppModule-a91ca7c371dc17046fd1789cc6d5dfc8"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-a91ca7c371dc17046fd1789cc6d5dfc8"' :
                                            'id="xs-components-links-module-AppModule-a91ca7c371dc17046fd1789cc6d5dfc8"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/DirectorDialogComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >DirectorDialogComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/UserProfileUpdateComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >UserProfileUpdateComponent</a>
                                            </li>
                                            <li class="link">
